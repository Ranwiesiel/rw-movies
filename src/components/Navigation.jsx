...
const Navigation = memo(() => {
  ...
  const isMoviePage =
    ...
    (location.pathname.match(/^\/[^/]+$/) && location.pathname !== "/tv");
  ...
  return (
    <nav
      className={`bg-white/95 backdrop-blur-md dark:bg-gray-900 dark:text-white py-4 sticky top-0 z-50 transition-transform duration-300 ${
      ...
      <Container>
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-1 rounded-full border border-gray-300 dark:border-gray-600 transition bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200"
          >
            {isDarkMode ? (
              <>
                <svg
              ...
              <>
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M12 3v1m0 16v1m8.66-8.66h-1M4.34 12H3.33m13.36-5.66l-.71.71M6.05 17.66l-.71.71m12.02 0l-.71-.71M6.05 6.34l-.71-.71M12 5a7 7 0 100 14 7 7 0 000-14z"
                  />
                </svg>
                <span>Light</span>
              </>
