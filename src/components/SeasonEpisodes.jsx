      ...
      <div>
        ...
        {!isLoading && !error && seasonData && seasonData.episodes && (
          <div>
            ...
            {seasonData.overview && (
              <p className="text-gray-600 text-sm mb-4">{seasonData.overview}</p>
            )}
                  ...
                  <div className="p-3 flex flex-col sm:flex-row sm:items-center gap-3">
                    ...
                    <div className="flex gap-2 mt-2 sm:mt-0">
                      {episode.vote_average > 0 && (
                        <div className="bg-gray-200 text-gray-800 px-2 py-1 rounded text-xs font-medium flex items-center gap-1 h-fit">
                    ...
                    <div className="border-t border-gray-200 p-4 bg-gray-50">
                      ...
                      {!showPlayer && (
                        <button
                          ...
                          className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded font-medium mb-4 flex items-center gap-2"
                        >
